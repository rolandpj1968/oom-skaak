...
namespace Chess {
  ...
  namespace MakeMove {
	...
	handlePawnsPushToPromo<StateT, PosHandlerT, BoardTraitsT, To2FromFn>(state, board, pawnsPushToPromoBb, directChecksBb, discoveriesBb, yourKingRookAttacksBb, yourKingBishopAttacksBb);
