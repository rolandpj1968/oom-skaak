...
int main(int argc, char* argv[]) {
  ...
  printf("           d1 nodes = %lu, d1 no checks = %lu, d1 no checks 2 = %lu, d1 no discoveries = %lu, d1 no illegals = %lu, d1 no nasty moves (wrong) = %lu\n", stats.d1nodes, stats.d1nochecks, stats.d1nochecksbypiece, stats.d1nodiscoveredchecks, stats.d1noillegalmoves, stats.d1nonastymoves);
}
