...
int main(int argc, char* argv[]) {
  ...
  printf("           l1 = %lu, l0 = %lu, l0-non-discoveries = %lu, l0-checker-takable = %lu, l0-check-king-can-move = %lu\n", stats.l1, stats.l0, stats.l0nondiscoveries, stats.l0checkertakable, stats.l0checkkingcanmove);
}
