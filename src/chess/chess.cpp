...
int main(int argc, char* argv[]) {
  ...
  auto whiteAttacks = genPieceAttacks<White, StartingColorTraitsT>(w, w.bbs[AllPieces] | b.bbs[AllPieces]);
  ...
  auto blackAttacks = genPieceAttacks<Black, StartingColorTraitsT>(b, w.bbs[AllPieces] | b.bbs[AllPieces]);
